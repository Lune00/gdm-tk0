...
//! \brief A brazilian system. Left and Bottom walls are fixed and the
//!  other walls can be submitted to VELOCITIES, FORCES or PRESSURES. 
//! \author V. Richefeu
class brazilian : public System
{
...
public:
	...
	brazilian(Sample* spl, Network* nwk, GroupRelationData * grpRel) : System(spl,nwk,grpRel)  
	{ 		
		xval_ = yval_ = 0.0;
